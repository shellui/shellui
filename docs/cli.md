...
2. **Framework scaffolding**:
   ...
   - **React / Vue / Angular / Next.js / Nuxt / SvelteKit / Alpine.js**: Official (or create-vite / ng new / Alpine npm) starters with `@shellui/sdk` wiring, fetched on-demand from GitHub
