...
Default Vite + React starter, embedded in the Shellui shell. `src/main.jsx` does a light `@shellui/sdk/tiny` `shellui.ready` handshake (no-op standalone). Edit `src/App.jsx` to build your app.
...
From the project root after `shellui init react`:
