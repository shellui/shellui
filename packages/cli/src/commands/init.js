 ...
 * @param {string|undefined} frameworkOrRoot - Framework shortcut (react/vue/angular/next/nuxt/svelte/alpine/empty) or root directory
 * @param {{
 *   force?: boolean,
 *   config?: string,
 *   framework?: string,
...
export async function initCommand(frameworkOrRoot, options = {}) {
  ...
  try {
    ...
    // Post-init dependency install for JS scaffolds (package.json). Empty / other: skip quietly.
